...
const SessionPage = () => {
  ...
  useEffect(() => {
    ...
    const fetchSessionData = async () => {
      try {
        ...
        const questions = await SupabaseService.getQuestionsForSession(sessionId);
        
        // Get analytics for this session
        const analytics = await SupabaseService.getAnalyticsForSession(sessionId);
  ...
  const handleSubmitQuestion = async (questionText: string) => {
    ...
    try {
      ...
      const newQuestion = await SupabaseService.submitQuestion(sessionId, questionText);
